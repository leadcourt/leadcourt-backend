 ...
 */
router.post('/summary', authenticateJWT, getListSummary);
 ...
 */
router.post('/store', authenticateJWT, storeList);
 ...
 */
router.post('/show', authenticateJWT, showList);
 ...
 */
router.post('/create', authenticateJWT, createEmptyList);
 ...
 */
router.post('/export', authenticateJWT, queueExportJob);

router.post('/rename', authenticateJWT, renameList);

router.delete('/:listName', authenticateJWT, deleteList);
